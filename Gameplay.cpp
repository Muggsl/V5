...
void Gameplay::epicText()
{
    ...
    cout << "In those two brief hours, two fleets full of high-tech battleship get ready to eliminate each other" << endl << endl;
}
...
void Gameplay::Play()
{
    ...
    if(loadGame != "y")
    {
        ...
        cin >> playerName;
        cout << "Welcome to the battlefield commander " << playerName << ", please place your ships with haste the nukes" << endl;
...
void SaveGame::saveGame(vector<vector<Tile>> AIgridCopy, vector<vector<Tile>> playerGridCopy, vector<vector<int>> AILocations, vector<vector<int>> playerLocationsCopy)
{
